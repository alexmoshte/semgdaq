...
float32_t  ADC1_IN1_OffsetCalc(ADC1_IN1_MA *ADC1_IN1_Offset_ptr); // Calculates the offset (mean of the baseline signal) for ADC1 channel 1 to be subtracted from data that follows
