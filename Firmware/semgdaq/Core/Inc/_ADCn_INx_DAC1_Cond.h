 ...
 *
 *  Header file for the that handles the conditional compilation for channel monitoring
 */
...
void ADC1_IN1_DAC_Update(ADC1_IN1_MA *ADC1_IN1_DAC_ptr); // Takes values from the moving average buffer and ports them to the DAC where the output from the DSP schemes is monitored using an oscilloscope
