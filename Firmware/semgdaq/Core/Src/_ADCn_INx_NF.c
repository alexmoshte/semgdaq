...
float32_t ADC1_IN2_States[2 * NOOFS_VARIABLES] = {0.0f};

ADC1_IN2_NF ADC1_IN2_NF_arg =
	{
	    .ADC1_IN2_numstages = 2,
	    ...
	    .ADC1_IN2_pcoeffs = ADC1_IN2_coeffs,

	    .ADC1_IN2_States = {0.0f},

	    .ADC1_IN2_pState = ADC1_IN2_States,

	    .ADC1_IN2_psrc = NULL,

	    .ADC1_IN2_pdst = ADC1_IN2_NF_arg._NF_ADC1_IN2_bfr,
...
float32_t ADC2_IN3_States[2 * NOOFS_VARIABLES] = {0.0f};

ADC2_IN3_NF ADC2_IN3_NF_arg =
	{
	    .ADC2_IN3_numstages = 2,
	    ...
	    .ADC2_IN3_pcoeffs = ADC2_IN3_coeffs,

	    .ADC2_IN3_States = {0.0f},

	    .ADC2_IN3_pState = ADC2_IN3_States,

	    .ADC2_IN3_psrc = NULL,

	    .ADC2_IN3_pdst = ADC2_IN3_NF_arg._NF_ADC2_IN3_bfr,
...
float32_t ADC3_IN1_States[2 * NOOFS_VARIABLES] = {0.0f};

ADC3_IN1_NF ADC3_IN1_NF_arg =
	{
	    .ADC3_IN1_numstages = 2,
	    ...
	    .ADC3_IN1_pcoeffs = ADC3_IN1_coeffs,

	    .ADC3_IN1_States = {0.0f},

	    .ADC3_IN1_pState = ADC3_IN1_States,

	    .ADC3_IN1_psrc = NULL,

	    .ADC3_IN1_pdst = ADC3_IN1_NF_arg._NF_ADC3_IN1_bfr,
...
float32_t ADC3_IN2_States[2 * NOOFS_VARIABLES] = {0.0f};

ADC3_IN2_NF ADC3_IN2_NF_arg =
	{
	    .ADC3_IN2_numstages = 2,
	    ...
	    .ADC3_IN2_pcoeffs = ADC3_IN2_coeffs,

	    .ADC3_IN2_States = {0.0f},

	    .ADC3_IN2_pState = ADC3_IN2_States,

	    .ADC3_IN2_psrc = NULL,

	    .ADC3_IN2_pdst = ADC3_IN2_NF_arg._NF_ADC3_IN2_bfr,
...
/* Assuming ADC1_DMA_sort_ptr is already initialized elsewhere in your code */
